...
begin
    lv_stmt := 'Delete CSYT_ADMIN.HSBA_DV where MaHSBA = '''|| CSYT_ADMIN.QLDL_Delete_HSBA.MAHSBA||'''';
    EXECUTE IMMEDIATE ( lv_stmt ); 
    lv_stmt := 'Delete CSYT_ADMIN.HSBA where MaHSBA = '''|| CSYT_ADMIN.QLDL_Delete_HSBA.MAHSBA||'''';
    EXECUTE IMMEDIATE ( lv_stmt );
end;
/
...
begin
    lv_stmt := 'Delete CSYT_ADMIN.HSBA_DV where MaHSBA = '''|| CSYT_ADMIN.QLDL_Delete_HSBA.MAHSBA||''''
    ||' and MaDV = '''||CSYT_ADMIN.QLDL_Delete_HSBA.MADV||'''';
    EXECUTE IMMEDIATE ( lv_stmt ); 
end;
